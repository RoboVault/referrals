...
from brownie import RewardsDistributor, accounts, config, network, project, web3
...
def main():
    ...
    if input("Deploy Rewards Distributor? y/[N]: ").lower() != "y":
        return

    rewardsDistributor = RewardsDistributor.deploy(
